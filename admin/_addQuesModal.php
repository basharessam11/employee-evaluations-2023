...
</head><body><input id="ques_id" type="hidden" value="0"><!-- هذا السطر لإستخدام نفس دالة التعديل على سؤال ولكن بدون حذف سؤال اخر -->

<div class="CurveBox" align="center" style="padding: 10px 20px 5px 20px; background-color: #f7f7f7;">
    <div class="form-group">
        <div align="center"><font>السؤال</font></div>
        <textarea class="form-control" id="ques" autofocus="" style="width: 100%; height: 70px; padding: 5px; resize: none;" maxlength="120" placeholder="السؤال..."></textarea>
    </div>
</div>
...
<div class="CurveBox" align="center" style="margin-top: 30px; padding: 10px 20px 5px 20px; background-color: #f7f7f7; overflow: hidden;">
    <div class="form-group" style="position: relative;">
        <input id="ansType" type="hidden" value="-2">
...
<div id="answerType1" style="width: 100%; position: absolute; top: 500px;">
    <div style="width: 100%; position: absolute; top: -50px; pointer-events: none;">
        <div align="center" style="margin-top: 5px;"><font style="font-size: 12px;">نموذج 1 من 9</font></div>
...
<div id="answerType2" style="width: 100%; position: absolute; top: 500px;">
    <div style="width: 100%; position: absolute; top: -50px; pointer-events: none;">
        <div align="center" style="margin-top: 5px;"><font style="font-size: 12px;">نموذج 2 من 9</font></div>
...
<div id="answerType3" style="width: 100%; position: absolute; top: 500px;">
    <div style="width: 100%; position: absolute; top: -50px; pointer-events: none;">
        <div align="center" style="margin-top: 5px;"><font style="font-size: 12px;">نموذج 3 من 9</font></div>
...
<div id="answerType4" style="width: 100%; position: absolute; top: 500px;">
    <div style="width: 100%; position: absolute; top: -50px; pointer-events: none;">
        <div align="center" style="margin-top: 5px;"><font style="font-size: 12px;">نموذج 4 من 9</font></div>
...
<div id="answerType5" style="width: 100%; position: absolute; top: 500px;">
    <div style="width: 100%; position: absolute; top: -50px; pointer-events: none;">
        <div align="center" style="margin-top: 5px;"><font style="font-size: 12px;">نموذج 5 من 9</font></div>
...
<div id="answerType6" style="width: 100%; position: absolute; top: 500px;">
    <div style="width: 100%; position: absolute; top: -50px; pointer-events: none;">
        <div align="center" style="margin-top: 5px;"><font style="font-size: 12px;">نموذج 6 من 9</font></div>
...
<div id="answerType7" style="width: 100%; position: absolute; top: 500px;">
    <div style="width: 100%; position: absolute; top: -50px; pointer-events: none;">
        <div align="center" style="margin-top: 5px;"><font style="font-size: 12px;">نموذج 7 من 9</font></div>
...
<div id="answerType8" style="width: 100%; position: absolute; top: 500px;">
    <div style="width: 100%; position: absolute; top: -50px; pointer-events: none;">
        <div align="center" style="margin-top: 5px;"><font style="font-size: 12px;">نموذج 8 من 9</font></div>
...
<div id="answerType9" style="width: 100%; position: absolute; top: 500px;">
    <div style="width: 100%; position: absolute; top: -50px; pointer-events: none;">
        <div align="center" style="margin-top: 5px;"><font style="font-size: 12px;">نموذج 9 من 9</font></div>
        <div align="center"><font style="font-size: 12px;">الفروع</font></div>
    </div>
    <div class="CurveBox5" style="padding: 10px; background: #ffffff; border: solid 2px green;">
...
<table style="width: 100%; margin-top: 20px;">
    <tbody><tr align="center">
        ...
        <td>
            <button type="button" class="btn btn-success" style="width: 100px; background-color: #75c34c; border: none;" onclick="addNewQuesAndDeleteOld(this);"><div style="margin-top: 3px;">إضافة</div></button>
        </td>
    </tr>
</tbody></table>

<script>
    //لوضع المؤشر على خانة السؤال فور فتح المودل
    $('#myModal3').on('shown.bs.modal', function() {
        document.getElementById('ques').focus();
    });
    
    //هذا الأمر لمنع حدوث ازدواج في الاي دي لأكثر من شيء في مودالات مختلفة حيث يمسح الكود الداخلي عند الإغلاق
