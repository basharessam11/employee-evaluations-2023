    ...
    else
    {
        ...
        $.ajax({ type: "POST",
                ...
                success: function(results)
                {
                    ...
                    {
                        alert('عذرا لا يمكن اضافة اكثر من حقل للفروع!');
                    }
                    else
                    {
                        alert('عذرا حدث خطأ! الرجاء التأكد من الاتصال بالانترنت!');
